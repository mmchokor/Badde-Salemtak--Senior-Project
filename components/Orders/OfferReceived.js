...
//   console.log(orderId)
  ...
  } = useQuery("listing", () => getResidentListingById(listingId), {
    staleTime: 1,
  });
  ...
  } = useQuery("order", () => getOrderById(orderId), { staleTime: 1 });
  ...
  if (isFetchingResident || isFetchingOrder || isListingLoading || isOrderLoading) {
    return <LoadingIcon />;
  }
  ...
  const totalPrice = listing.price + order.deliveryFee + 10 + 5
