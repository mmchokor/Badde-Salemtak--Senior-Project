...
const PublicProfileScreen = ({ navigation, route }) => {
  ...
  const { data: userInfo, isFetching, refetch } = useQuery("userInfo", getCurrentUser);
  const { data: publicuserInfo, isFetching: fetchinguserInfo } = useQuery(
    "userInfoid",
      ...
      >
        ...
        <View style={styles.userInfoWrapper}>
          ...
          <Text style={[styles.text, styles.date]}>
            ...
            {formatDate(publicuserInfo.createdAt)}
          </Text>
        </View>
